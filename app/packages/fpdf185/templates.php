...
//                  "qte"     => qte,
//                  "tva"     => code_tva );
function addTVAs( $total, $subtotal, $vat )
{
	...
	$this->SetFont( "Arial", "", 8);
	$this->SetXY( $rf, $y1+5 );
	$this->Cell( 17,4, EURO . " ". sprintf("%0.2F", $total), '', '', 'R');
	$this->SetXY( $rf, $y1+10 );
	$this->Cell( 17,4, EURO . " ". sprintf("%0.2F", $vat), '', '', 'R');
	$this->SetXY( $rf, $y1+14.8 );
	$this->Cell( 17,4, EURO . " ". sprintf("%0.2F", $subtotal), '', '', 'R');
	// $this->SetXY( $rf, $y1+5 );
...
// Company
function addInformation( $nom, $adresse )
{
	$x1 = 10;
	$y1 = 20;
	//Positionnement en bas
...
function addLocationInformation( $nom, $adresse )
{
	$x1 = 10;
	$y1 = 80;
	//Positionnement en bas
