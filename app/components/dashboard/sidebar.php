...
<nav class="py-8 px-4 bg-primary h-screen fixed w-[17rem] flex flex-col">
    ...
    <ul class="flex flex-col gap-y-1 text-white">
        <li><a href="/dashboard" class="flex gap-x-2 rounded hover:bg-teal-800 p-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                </svg>
                <h4>Dashboard</h4>
            </a>
        </li>
        <li><a href="/dashboard/accounts" class="flex gap-x-2 rounded hover:bg-teal-800 p-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                </svg>
                <h4>Accounts</h4>
            </a>
        </li>
        <li><a href="/dashboard/orders" class="flex gap-x-2 rounded hover:bg-teal-800 p-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <li class="accordion cursor-pointer flex justify-between items-center rounded hover:bg-teal-800 p-2">
            <div class="flex gap-x-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 8.25V18a2.25 2.25 0 002.25 2.25h13.5A2.25 2.25 0 0021 18V8.25m-18 0V6a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 6v2.25m-18 0h18M5.25 6h.008v.008H5.25V6zM7.5 6h.008v.008H7.5V6zm2.25 0h.008v.008H9.75V6z" />
                </svg>
                <h4>Content</h4>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 chevron chevron-open">
                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
            </svg>
        </li>
        <ul class="flex flex-col gap-y-2 text-white pl-10 my-2 hidden text-sm w-full">
            <li class="w-full"><a class="flex rounded hover:bg-teal-800 w-full p-1" href="/dashboard/content/home-page">Home
                    page</a></li>
            <li class="w-full"><a class="flex rounded hover:bg-teal-800 w-full p-1" href="/dashboard/content/information-pages">Information pages</a></li>
        </ul>
        <li class="accordion cursor-pointer flex justify-between items-center rounded hover:bg-teal-800 p-2">
            <div class="flex gap-x-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <li class="accordion cursor-pointer flex justify-between items-center rounded hover:bg-teal-800 p-2">
            <div class="flex gap-x-2"><svg fill="#FFF" viewBox="-5.5 0 32 32" class="w-6 h-6" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <title>music</title>
    ...
    <button class="flex gap-x-2 rounded hover:bg-teal-800 p-2 mt-auto text-white"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
