<footer class="bg-[url('../assets/footer-image.png')] bg-no-repeat w-screen" style="background-size:100%;">
        ...
        <div class="container flex flex-col-reverse justify-between px-3 py-10 mx-auto space-y-8 md:flex-row md:space-y-0">
            ...
            <a href="/">
                ...
                <div>
                    <ul class="flex justify-center space-x-4">
                        <li class="mb-2">
                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-7  text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex justify-between space-x-32 py-4">
                <div class="flex flex-col space-y-1">
                    <ul class="list-none">
                        <h2 class="text-white font-bold text-3xl mb-2">Festival</h2>
                        <li class="mb-2">
