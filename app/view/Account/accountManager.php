            ...
            <section class="bg-white rounded-lg shadow-lg p-12 mb-10 mt-5">
                ...
                <div class="relative w-40 h-40 rounded-full overflow-hidden max-w-md mx-auto mb-3">
                    ...
                    <div id="profile_picture_placeholder"
                        class="absolute inset-0 w-full h-full flex justify-center items-center text-center cursor-pointer z-10 hover:text-blue-500 hover:bg-blue-100">
                        <svg class="w-12 h-12 text-gray-400 fill-current mb-1" viewBox="0 0 24 24">
                            <path
                                d="M16 6h-3.5c-.83 0-1.57.33-2.12.88L6.71 12.29a1 1 0 0 0 0 1.42l2.83 2.83a1 1 0 0 0 1.42 0l4.41-4.41c.55-.55.88-1.28.88-2.12V8a4 4 0 0 0-4-4H4a1 1 0 0 0 0 2h8a2 2 0 0 1 2 2v.5c0 .28.22.5.5.5s.5-.22.5-.5V8a1 1 0 0 0-1-1H4a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h8a1 1 0 0 0 0-2H4a1 1 0 0 1-1-1V8h11.5c.28 0 .5-.22.5-.5s-.22-.5-.5-.5z" />
                            <path d="M0 0h24v24H0z" fill="none" />
                        </svg>
                        <span class="text-xs font-medium">Edit Profile Picture</span>
                    </div>
                    <img id="profile_picture_preview" src=""
                        class="absolute inset-0 h-full w-full object-cover rounded-full border-2 border-gray-300 shadow-md z-0">
                ...
                <div class="flex items-center mb-3">
                    <a href="/customer/manage-account/change-email" class="hover:text-blue-500 flex items-center"><span
                            id="email" class="mr-2"></span><i class="fas fa-pencil-alt"></i></a>
                </div>
                ...
                <div class="text-right">
                    <button id="update_account_button" type="submit"
                        class="bg-primary text-white py-2 px-4 rounded font-bold">Update
                        Account</button>
                </div>
            </section>
        </div>
