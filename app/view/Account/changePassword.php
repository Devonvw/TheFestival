    ...
    <div class="max-w-md mx-auto mt-24">
        ...
        <section class="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <form id="change_password_form" class="mb-4">
                ...
                <div class="mb-8">
                    <label for="confirm_password" class="block text-gray-700 font-bold mb-2">Confirm New
                        Password</label>
                    <input id="confirm_password" name="confirm_password" type="password"
                        class="w-full px-4 py-2 border border-gray-600 rounded-lg">
                </div>
                <div class="text-right">
                    <button onclick="updatePassword()" id="change_password" type="button"
                        class="bg-primary text-white py-2 px-4 rounded font-bold">Change password</button>
